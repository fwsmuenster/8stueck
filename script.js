...
const cast = [
    ...
    {order: "14", name: "Jona/Leander", rolle: "Flanagen", info:  "Flanagan ist Mitglied im Club der Exzentrischen. Die anderen Exzentrischen mögen ihn nicht so gerne wegen seiner abgehobenen Art.", img: "bilder/bild.svg" },
    {order: "15", name: "Carl/Richard", rolle: "Wärter", info:  "Der Wärter ist eigentlich unwichtig für das Stück, aber trotzdem der einzige Kontakt zur Außenwelt für Mr. Fogg als dieser im Gefängnis sitzt.", img: "bilder/bild.svg" },
...
const meineFotos = [
    ...
    {url:'bild2.jpeg',info:''},
    {url:'bild10.jpeg',info:''},
    {url:'bild11.jpeg',info:''},
    {url:'bild12.jpeg',info:''}
];
